...
library(tm)  # working with text corpus
library(topicmodels) # topic models package
library(ggplot2) # plotting
library(ggthemes) # using different themes with ggplot2
library(tidytext) # working with text
library(lda) # topic models package
library(plotly) # interactive plots

#------------ load data -----------------------
df = read.csv("Data/un-general-debates.csv", stringsAsFactors = FALSE)
# read country codes
# generated by getCountryCodes.R
...
# found a few that don't have a country name likely because
# country name changed for a few countries over time
...
#--- Scores plot for a given PC shows a pattern
pickpc = "PC1"

ggplot() + geom_line(data = scoresdf, aes_string(x = "year", y = pickpc)) + theme_bw()

# Top and Bottom words in terms of loadings for the PC indicate words
#  that follow the pattern. This is one way to pick words that show patterns
# instead of pre-postulating which words have interesting patterns
